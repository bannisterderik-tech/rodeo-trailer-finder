// GENERATED from dc-runtime/src/*.ts Ñ do not edit. Rebuild with `cd dc-runtime && bun run build`.
"use strict";
(() => {
  ...
  function createComponentFactory(registry, ensureFetched) {
    ...
    class StreamableComponent extends React.Component {
      constructor(props) {
        ...
        /** Snapshot of the registry's streaming flags taken at render time Ñ
        ...
        /** Per-instance constructor error Ñ kept here (not on the registry entry)
       ...
       *  over its initial state Ñ used both at mount and on hot-swap. */
      ...
      /** The props the author's logic + template see Ñ internal __-prefixed
       *  wiring stripped. */
      __userProps() {
  ...
  function init() {
    ...
    const api = {
      ...
      /** Name of the component currently mounted as the page root Ñ DC tools
       *  push their template-stream here when targeting "the open page". */
      __dcRootName: () => rootName,
      /** Editor bridge Ñ the encoded, `data-dc-tpl`-annotated template source.
      ...
      /** Editor bridge Ñ the *original* (decoded) template source. */
